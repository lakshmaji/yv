...
Archived from `CLAUDE.md`. This is a record of how yv was built, kept for the
reasoning behind decisions — not a description of the current codebase. For that
see [DEVELOPMENT.md](../DEVELOPMENT.md), [FEATURES.md](../FEATURES.md) and
[RELEASING.md](../RELEASING.md).

Entries are in the order they were written. Some describe code that has since
changed, and the earliest ones predate the SolidJS migration entirely.
